...
# Create a simple credentials file (you can edit this later)
credentials = {
    "usernames": {
        "miava": {  # Change this username if you want
            "email": "miavasullivan@hotmail.com",
            "name": "Miava",
            "password": hashlib.sha256("dogfather".encode()).hexdigest()  # CHANGE THIS!
        }
    }
}

# For production: save to credentials.yml (but for now, we'll use in-memory)
authenticator = stauth.Authenticate(
    credentials,
    "finance_dashboard",
    "random_signature_key_12345",  # Change this too for real use
